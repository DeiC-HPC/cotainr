...
.. grid:: 1
    ...
    .. grid-item-card:: Getting the `cotainr` source code
        ...
        .. dropdown:: Installation instructions
            ...
            `cotainr` only runs on Linux and requires that `Python`_ >=3.8 as well as `Singularity`_ >=3.7.4 or `Apptainer`_ >=1.0 is installed on the system. More details about dependencies may be found in the :ref:`development section <section_development>`.
